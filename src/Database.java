...
public class Database {
    // sql login
    private static final String DATABASE_URL = ""; // TODO input a database url
    private static final String USERNAME = ""; // TODO input the username to database
    private static final String PASSWORD = ""; // TODO input the password to database
